...
console.log(uploadedFile);
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      setUploading(true);
      const res = await axios.post<UploadResponse>("/api/uploadfile", formData, {
      ...
      form.setValue("receiptPath", res.data.file.path);
    } catch (error) {
...
//                         <Input
//                           type="file"
//                           accept="image/*,.pdf,.doc,.docx" // customize allowed file types
//                           onChange={(e) => {
